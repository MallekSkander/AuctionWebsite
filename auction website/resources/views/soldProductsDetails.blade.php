...
<div class="row">
  ...
  <div class="col-md-8 col-sm-12">
    ...
    @if(!$product->isBidden())
        <div><p class="text-center">You may also delete this auction record because no one has bade on this product <br><br></p>
        <a href="{{route('soldDelete',$product->id)}}" onclick="event.preventDefault();document.getElementById('deleteAuction').submit();">
            <button class="btn btn-danger btn-xs"> Delete auction</button> </a>
